...
public class MoneyManager : MonoBehaviour
{
    ...
    private int[] MachineLevels = new int[3];
    private int[] MachineMoneys = new int[3];
    ...
    public void ShowMachineSpeedIncrease(int index)
    {
        ...
        {
            case 0:
                MachineSpeedIncrease("그릴 작업 속도 증가", 120, 5, index);
                break;
            case 1:
                MachineSpeedIncrease("탄산음료 작업 속도 증가", 140, 7, index);
                break;
            case 2:
                MachineSpeedIncrease("감자튀김 작업 속도 증가", 150, 8, index);
                break;
        }
    }
    ...
    private void MachineSpeedIncrease(string messagePrefix, int baseCost, int rateIncrement, int index)
    {
